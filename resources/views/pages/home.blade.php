                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4">
                      <div class="card card-testimonial text-center">
                          <div class="testimonial-content">
                              ...
                              class="mb-4 rounded-circle"
                              >
                              <h3 class="mb-4">Phil Anggara</h3>
                              <p class="testimonial">
                                  " The trip was amazing and I saw something beautifull in that 
                                  city that makes me want to learn more "
                              </p>
                          </div>
                          <hr>
                          <p class="trip-to mt-2">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4">
                      <div class="card card-testimonial text-center">
                          <div class="testimonial-content">
                              ...
                              class="mb-4 rounded-circle"
                              >
                              <h3 class="mb-4">Jenifer Damar</h3>
                              <p class="testimonial">
